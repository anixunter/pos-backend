...
router.register(r'customers_deposit', CustomerDepositViewSet, basename='customers_deposit')
router.register('categories', CategoryViewSet, basename='categories')
router.register('suppliers', SupplierViewSet,  basename='suppliers')
router.register('products', ProductViewSet, basename='products')
router.register(r'inventory_adjustments', InventoryAdjustmentViewSet, basename='inventory_adjustments')
